...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Void>> sendPhoneCode(@Valid @RequestBody SendPhoneCodeRequest req, HttpSession session) {
    ...
    public ResponseEntity<ApiResponse<Void>> verifyPhone(@Valid @RequestBody VerifyCodeRequest req, HttpSession session) {
    ...
    public ResponseEntity<ApiResponse<Void>> sendEmailCode(@Valid @RequestBody SendEmailCodeRequest req, HttpSession session) {
    ...
    public ResponseEntity<ApiResponse<Void>> verifyEmail(@Valid @RequestBody VerifyCodeRequest req, HttpSession session) {
    ...
    @PostMapping("/signup")
    public ResponseEntity<ApiResponse<Void>> signUp(@Valid @RequestBody SignUpRequest req, HttpSession session) {
        authService.signUp(req, session);
        return ResponseEntity.ok(ApiResponse.onSuccessCreate(null));
    }
    ...
    public ResponseEntity<ApiResponse<Boolean>> isUsernameAvailable(@RequestParam String username) {
        return ResponseEntity.ok(ApiResponse.onSuccess(authService.isUsernameAvailable(username)));
    }
