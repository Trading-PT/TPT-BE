...
public interface MonthlyTradingSummaryRepository
	...
	/**
	 * 특정 고객의 최신 월간 매매 요약 조회 (evaluator 무관)
	 ...
	 *
	 * @param customerId 고객 ID
	 * @return 가장 최근 월간 매매 요약 (없으면 empty)
	 */
	Optional<MonthlyTradingSummary> findTopByCustomer_IdOrderByPeriodYearDescPeriodMonthDesc(
		Long customerId
	);
}
