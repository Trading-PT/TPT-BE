...
public class RecurringPaymentService {
    ...
    private void handleRegularPayment(
        ...
        try {
            ...
            // 구독 실패 횟수 증가
            Subscription updatedSubscription = subscriptionCommandService.incrementPaymentFailureCount(subscription.getId());
    ...
    private RecurringPaymentResponseDTO createMockSuccessResponse(Payment payment) {
        ...
        response.setAuthDate(java.time.LocalDateTime.now().format(
